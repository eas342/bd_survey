...
For \shb\ we find that the median particle radius is better constrained.
...
A log-normal particle size distribution with a median of 0.16$\mu$m fits the data with a $\chi^2$ per degree of freedom of 0.99.
