...
These shifts were used to apply a custom flat field for every image\textbf{, while shifting the sky flat (with pixel-to-pixel response removed) and maintaining the position of the pixel-to-pixel flat}.
