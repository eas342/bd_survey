...
Finally, we attempt a model where we restrict the temperature limits to [1300,2500] to ensure that the final effective temperature is close to the measured 1600 K \citep{citet{gagne2015banyan7}}.
The best fit model has $T_{eff} \approx $1590 K, but pushes to the edges of our prior with $T_1$ = 2500 K and $T_2$ = 1300 K.
This model fits with $\bar{\chi}^2$ = 2.1.
However, the temperature contrasts in these models are significantly more than the expected 50 K horizontal temperature variations expected in circulation models \citep{showman2013bdgpDynamics}.
