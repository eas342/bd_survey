...
We attribute this to correlated errors between wavelengths.
...
\caption{Sine fit amplitude versus wavelength excluding the wavelength regions contaminated by telluric absorption. [SOMETHING HERE? like, The data are fit] with simple Mie scattering models with a log-normal particle size distribution centered at 0.1 and 0.2~$\mu$m.}\label{fig:ampspec1821mie}
\end{centering}
\end{figure}
