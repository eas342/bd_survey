...
\tablenotetext{e}{\citet{koen2004ibandBD}}
\end{table*}
...
\caption{A simple two layer model with two different temperatures and different areal fractions for longitudes 0\degree\ and 180\degree.}\label{fig:tdiffschem}
\end{centering}
\end{figure}
...
I should change the spot model fit to the following model
\begin{equation}
...
We obtained high precision ground-based spectrophotometry of both systems to measure the variability spectra of these systems.
After fitting sinusoids to both of the time series, we find that the 
