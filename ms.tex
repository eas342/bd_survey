...
\caption{Sine fit amplitude versus wavelength excluding the wavelength regions contaminated by telluric absorption. The data are fit] with simple Mie scattering models with a log-normal particle size distribution of forsterite grains.}\label{fig:ampspec1821mie}
\end{centering}
\end{figure}
