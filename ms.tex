...
\begin{deluxetable*}{lllcccccccl}[t]
...
\startdata
2MASS~J08354256$-$0819237 & L5 & L7 & 8.52$\pm$0.08 & 11.94$\pm$0.02 & 2.03$\pm$0.03 & 1754$\pm$112 & 3.1\tablenotemark{b} & 14.18$\pm$0.43 & 21 & 1-5 \\
2MASS~J18212815+14140101 & L4.5p & L5 & 9.38$\pm$0.03 & 12.40$\pm$0.02 & 1.78$\pm$0.03 & 1614$\pm$100\tablenotemark{c} & 4.2$\pm$0.1 & 28.85$\pm$0.16 & 83 & 5-10 \\
\enddata
...
Figure~\ref{fig:tbright} shows the resulting brightness temperature spectra and their uncertainties from these calculations.  The spectral peaks for {\sha} are roughly constant at {\teff} = 1900$\pm$50~K in the field surface gravity case, and declines from 1700$\pm$20~K at the $J$-band peak to 1570$\pm$60~K at the $K$-band peak in the low surface gravity case. Spectra models (e.g., \citealt{2012RSPTA.370.2765A}) predict brightness temperatures closer to the effective temperature at the $JHK$ flux peaks, so these data suggest {\sha} has an intermediate age/radius compared the assumptions made here. For {\shb}, 
brightness temperatures range from 1880$\pm$30~K at the $J$-band peak to 1700$\pm$40~K at the $K$-band peak. These values are notably warmer than the {\teff} = 1614$\pm$100~K estimated from \citet{2015ApJ...810..158F} {\teff}/spectral type relation, but relatively consistent this source's earlier spectral type as compared to {\sha}. We conjecture that the Filippazzo et al.\ relation underestimates the {\teff} of this source due to its unusually dusty spectral energy distribution.
...
The trends near 1.4 $\mu$m and 1.8 $\mu$m could probably be reduced by better wavelength shifting.
...
As seen in Figure \ref{fig:manualVsAutoShift0835}, the manual shifting could reduce some of the trends in the dynamics spectra.
...
Two iterations were used in the manuals shifting: (1) minimizing the residuals of the target divided by reference and (2) minimizing the residuals of the target divided by the middle spectrum.
...
\subfloat[2MASS J1821- Automatic Shifting]{
	...
	\caption{Dynamic spectra of {\sha} using manual wavelength shifting(left) and automatic cross correlation wavelength shifting (right).
	The manual method shows some decreased linear trends in these dynamic spectra which have no fits along columns to remove trends.}
