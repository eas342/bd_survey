...
\caption{Color-Magnitude diagram from \citet{dupuy2012ltparallax}. We added 2MASS J0835 and 2MASS J1821 using Simbad magnitudes and parallaxes.}\label{fig:CMD}
\end{centering}
\end{figure}
...
\caption{Example posterior distributions for an MCMC fit to the time series using Equation \ref{eq:cosfit2term} }\label{fig:post2Cosfit}
\end{centering}
\end{figure}
...
We also use \texttt{emcee} to fit the amplitude spectrum of 2MASS J1821 using the two temperature surface model 
