...
In addition to these direct spectroscopy and photometry, brown dwarfs may be observed over their rotation periods to understand the spatial cloud structure and composition, that can change rapidly with time.
...
-- & hr & -- & -- \\
\hline \hline
2MASS J1821+14010 & 4.2\footnote{\citet{metchev2015weatherII}} & L4.5 & 11.14 \\
...
\caption{Sine fit amplitude versus wavelength with simple Mie scattering models with a log-normal particle size distribution centered at 0.1 and 0.2~$\mu$m}\label{fig:ampspec1821mie}
\end{centering}
\end{figure}
