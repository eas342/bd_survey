...
\caption{Sine fit amplitude versus wavelength with simple Mie scattering models with a log-normal particle size distribution centered at 0.1 and 0.2~$\mu$m}\label{fig:ampspec1821}
\end{centering}
\end{figure}
