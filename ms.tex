...
\textbf{These structures} may produce rotationally-modulated brightness variations (e.g., \citealt{2012ApJ...750..105R}) \textbf{and} long-term variations from differential rotation and/or cloud structure evolution (e.g., \citealt{2009ApJ...701.1534A,2013A&A...555L...5G,2016ApJ...826....8Y}). Evidence of cloud-driven variability extends to the cooler T dwarfs (e.g., \citealt{2009ApJ...701.1534A,2012ApJ...760L..31B,2015ApJ...799..154M}), virtually all L dwarfs and most T dwarfs likely have cloud deck heterogeneities leading to infrared flux variations $\gtrsim$0.2\% in amplitude \citep{2015ApJ...799..154M}. Clouds and hazes are important constituents of exoplanetary atmospheres as well (e.g., \citealt{2011ApJ...733...65B,2014Natur.505...69K,2016Natur.529...59S}).
...
\centering
	...
	from the IRSA Finderchart service (\url{http://irsa.ipac.caltech.edu/applications/finderchart/}).  Each image is centered on the target \textbf{and spans} a 1$\arcmin\times$1$\arcmin$ field of view oriented with North up and East the left.
	The \textbf{reference stars labeled in each image are observed simultaneously in the 3$\arcsec \times 60 \arcsec$ SpeX slit to remove telluric variability.}}
	\label{fig:images}
	\vspace{0.17in}
\end{figure*} 
...
For {\shb}, we assumed \textbf{a} lower age limit of 200~Myr based on its field gravity classification, and an upper limit of 700~Myr based on the analysis of \citet{2016MNRAS.455..357S}. The \textbf{\citet{2003A&A...402..701B}} evolutionary models predict radii of 0.097--0.114~R$_{\odot}$ for these ages and the luminosity of {\shb}.  
...
Relative spectra (source \textbf{divided by} reference) were then computed for each exposure.
...
\subfloat[2MASS J1821]{
	...
	\caption{(Top panels) Sine fit amplitude versus wavelength for each brown dwarf. \sha\ shows only marginally significant variability near 1.7~$\micron$ and 2.1--2.4~$\micron$, and no obvious trends with wavelength. \shb\ has significant variability over wavelengths $<$1.7$\micron$ with a strong spectral slope.
	 Also shown is the WFC3 amplitude spectrum of \shb\ from \citet{2015ApJ...798L..13Y}. The WFC3 observations were obtained \textbf{at} a different epoch, but show a similar slope.
	 The amplitude spectrum for \shb\ is fit to a simple Mie scattering model with a log-normal particle size distribution of spherical forsterite grains; the best fit has a median particle \textbf{radius} of 0.28 $\mu$m.
...
\textbf{We impose} 2.6 $< \tau <$ 3.6 hr for \sha\ and 3.7 $< \tau <$ 4.7 hr for {\shb}, $\pm$0.5 hr around the literature values.
...
\textbf{If one were to average all of the K-band points together, they are consistent with a 3.4 $\pm$ 0.1 hr rotation period, though this is somewhat driven by the prior 2.6 $< \tau < $3.6 hr.}
...
The period of \shb\ is found to be consistent with that of \citet{2015ApJ...799..154M}, \textbf{4.2$\pm$0.1 hr}.
...
We model the wavelength dependence of variability amplitudes for \shb\ with a simple cloud model: an \textbf{optically thin grouping of clouds} consisting of a log-normal distribution of particle sizes.
\textbf{
...
We model the single particle extinction coefficient, $Q_{ext}$ \textbf{with} the \texttt{Python} Mie theory code \texttt{miescatter} \citep{bohren1983mie} to calculate the opacity as a function of wavelength.
...
{\shb} shows significant variability up to the 1.5\% amplitude (3.0\% peak-to-valley) at short wavelengths (0.9~$\mu$m), which declines \textbf{toward} the near infrared (2.4$~\mu$m).
...
\textbf{Thanks to the anonymous referee for useful improvements and corrections to this work.}
