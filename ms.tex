...
\subfloat[2MASS J1821 - 2.5$\times \sigma$]{
	\includegraphics[width=0.5\textwidth]{2mass_0835_spectrum_0250perc_err_taurestric.pdf}
...
As with \shb\ I imposed a tight prior on $\tau$ such that $3.0 < \tau < 3.2$ for \sha. This now gives an average amplitude of zero -- see Figure \ref{fig:amp2mass08352p5ErrTauRest}.

\begin{figure}
\begin{centering}
\includegraphics[width=0.5\textwidth]{2mass_0835_spectrum_0250perc_err_taurestric.pdf}
\caption{Amplitude spectrum for \sha\ with error bars scaled by 2.5$\sigma$. The average amplitude is zero.}\label{fig:amp2mass08352p5ErrTauRest}
\end{centering}
\end{figure}
