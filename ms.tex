...
I made a time series of my photometry to see if it would help with the spectrum fit.

The SNR is so low that's it hard to see any clear pattern.
The photometry adds very little to the spectrum, as seen in Figure \ref{fig:morisPhotometryAndSpec}.
...
\subfloat[Amplitude spectrum for \shb\ when adding MORIS photometry]{
	...
	\caption{MORIS photometry does not significantly improve the constraints on the spectrum.}
