...
\subfloat[2MASS J1821 - 4$\times \sigma$ ]{
	...
	\caption{Restricting the $\tau$ parameter to, $3.8 < \tau < 4.0$ significantly reduces the long term quadratic terms' contribution to the sinusoidal fit. In this case, there were two MCMC fits for \shb, one with error bars scaled by 2.5$\sigma$ and the other by 4.0$\sigma$.}
	\label{fig:ampSpec1821TauRestrict}
	\vspace{0.1in}
\end{figure*} 
