...
As described in \citet{2016ApJ...826..156S}, we performed spatial background subtraction over the entire slit using a 4th-order polynomial fit to points more than 30 pixels away from the center of the source dispersion traces.  Spectra were optimally extracted \citep{1986ApJ...302..757H}, with spatial profiles fit to low order polynomials {\bf [REALLY? NOT A MEDIAN PROFILE? OR A MODIFIED GAUSSIAN? LOW ORDER POLY WOULDN'T CAPTURE PSF SHAPE I THINK]} with 20$\sigma$ rejection to remove cosmic rays and bad pixels.
