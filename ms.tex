...
For \sha\ we use a prior 2.6 $< \tau < $3.6 hr from \citet{2004MNRAS.354..378K} and for \shb\ we use 3.7 $< \tau <$ 4.7 hr from \citet{2015ApJ...799..154M}, using wide 0.5 hr priors around the measured values.
These priors are used to ensure that the sinusoidal fits to not fit the airmass trends with time.
...
The linear baseline terms as a function of time and airmass in Equation \ref{eq:cosfit} fit the baseline variations not due to the brown dwarf variations.
